...
class ClientTest(unittest.TestCase):
  ...
  def test_getRatio_PriceALessThanPriceB(self):
    self.assertLess(getRatio(120.55, 124.76), 1)

  def test_getRatio_PriceAGreaterThanPriceB(self):
    self.assertGreater(getRatio(121.49, 119.28), 1)

  def test_getRatio_DivisionByZeroCase(self):
    self.assertTrue(isinf(getRatio(108.56, 0)))
